    ...
    try:
        completion = groq_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"You are {PROFILE_NAME}'s AI digital twin. Answer questions as if you are the person, speaking in first person about their background, skills, and experience. Be professional, confident, and detailed."
                },
                {
                    "role": "user",
                    "content": prompt
