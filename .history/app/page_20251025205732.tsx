      ...
      <div className="relative max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="text-center mb-8 pt-8">
          ...
          <div className="flex items-center justify-center gap-3 mt-4">
            <a 
              href="/dashboard" 
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/50 rounded-lg text-blue-300 hover:text-blue-200 transition-all text-sm font-medium"
            >
              <span>📊</span> Advanced Dashboard
            </a>
          </div>
