  ...
  try {
    ...
    switch (body.method) {
        ...
        if (!question || typeof question !== "string") {
          return NextResponse.json({
            ...
            error: {
              code: -32602,
              message:
                "Invalid params: question is required and must be a string",
            },
            id: body.id,
          });
        }
            ...
            tools: [
              {
                ...
                description:
                  "Query the digital twin about professional background, skills, experience, and projects",
                inputSchema: {
                  type: "object",
                  properties: {
                    question: {
      ...
      case "tools/call":
        ...
        const toolArgs = body.params?.arguments as
          | { question?: string }
          | undefined;
        ...
        return NextResponse.json({
          ...
          result: {
            ...
            endpoints: {
              ...
              query_enhanced:
                "Ask questions with LLM-enhanced preprocessing and formatting",
...
export async function GET() {
  return NextResponse.json({
    ...
    features: {
      ...
      enhancedRAG:
        "LLM-powered query enhancement + interview-focused responses",
    ...
    examples: {
      ...
      enhancedQuery: {
        ...
        params: {
          question: "Tell me about your best project for an interview",
        },
        id: 2,
      },
      comparison: {
