    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-blue-950 to-gray-950 relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex">
        ...
        <div className="flex-1 flex flex-col lg:ml-80">
          {/* Header */}
          <div className="border-b border-white/10 backdrop-blur-xl bg-gray-900/30 px-4 sm:px-6 py-3 sm:py-4">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
              {messages.length === 0 && !isStreaming && (
                <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-600/20 flex items-center justify-center mb-4 sm:mb-6 backdrop-blur-sm border border-white/10">
                    <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 text-blue-400" />
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2 sm:mb-3">
                    Welcome to My Digital Twin
                  </h2>
                  <p className="text-slate-400 text-sm sm:text-lg mb-6 sm:mb-8 max-w-2xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl">
                    {sampleQuestions.slice(0, 4).map((q) => (
                      <button
                        ...
                        className="p-3 sm:p-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-500/50 rounded-xl text-left text-xs sm:text-sm text-slate-300 hover:text-white transition-all group"
                        disabled={isLoading || isStreaming}
                      >
                        <div className="flex items-start gap-2 sm:gap-3">
                          <Sparkles className="w-4 h-4 text-blue-400 mt-0.5 group-hover:scale-110 transition-transform flex-shrink-0" />
                          <span>{q}</span>
                        </div>
                      </button>
                    ))}
