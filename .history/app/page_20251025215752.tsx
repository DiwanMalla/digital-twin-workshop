...
import { Check, Copy, Trash2, Send, Sparkles, User, Bot, RotateCw, Database, Zap, Brain } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-blue-950 to-gray-950 relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-80 flex-col border-r border-white/10 backdrop-blur-xl bg-gray-900/50 p-6">
            ...
            <div className="mb-6">
              <div className={`p-4 rounded-xl border backdrop-blur-sm ${
                ...
                <div className="flex items-center gap-2 mb-2">
                  <Database className={`w-4 h-4 ${dbStatus.success ? "text-emerald-400" : "text-rose-400"}`} />
                  <span className={`text-sm font-medium ${dbStatus.success ? "text-emerald-400" : "text-rose-400"}`}>
          ...
          <div className="mb-6 space-y-3">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <span className="flex items-center gap-1.5 text-xs">
                ...
                <span className="text-white">{isStreaming ? 'Active' : 'Idle'}</span>
              </span>
            </div>
          </div>
          ...
          {/* Tech Stack */}
          <div className="mb-6">
            <h3 className="text-xs font-semibold text-slate-400 mb-3 uppercase tracking-wider">Powered By</h3>
            ...
            <div className="max-w-5xl mx-auto px-6 py-6 space-y-6">
              {messages.length === 0 && !isStreaming && (
                <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-600/20 flex items-center justify-center mb-6 backdrop-blur-sm border border-white/10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl">
                    {sampleQuestions.slice(0, 4).map((q) => (
                      <button
                        ...
                        className="p-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-500/50 rounded-xl text-left text-sm text-slate-300 hover:text-white transition-all group"
              ...
              {messages.map((msg, idx) => (
                ...
                >
                  ...
                  {msg.type === "user" && (
                    <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center shadow-lg">
              ...
              {isStreaming && streamingMessage && (
                <div className="flex gap-4 justify-start animate-fade-in">
                  ...
                  <div className="max-w-[75%] rounded-2xl px-5 py-4 bg-white/5 backdrop-blur-sm text-slate-100 border border-blue-500/30 shadow-lg shadow-blue-500/20">
                    ...
                    <div className="flex items-center gap-2 mt-3 pt-3 border-t border-white/10">
                      ...
                      <p className="text-xs text-blue-400">Streaming response...</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="border-t border-white/10 backdrop-blur-xl bg-gray-900/50">
            <div className="max-w-5xl mx-auto px-6 py-4">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex gap-3">
                  <input
                    ...
                    placeholder="Ask me anything about Diwan's experience, skills, projects..."
                    className="flex-1 px-5 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent text-white placeholder-slate-500 transition-all text-sm"
                    disabled={isLoading || isStreaming}
                  />
                  <button
                    type="submit"
                ...
                {messages.length === 0 && !isStreaming && (
                  <div className="flex flex-wrap gap-2">
                    <span className="text-xs text-slate-500 py-2">Try asking:</span>
              ...
              <p className="text-xs text-center text-slate-500 mt-4">
                Powered by Next.js 15 • Upstash Vector • Groq AI • Real-time Streaming
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="border-t border-slate-800/50 p-4 bg-slate-900/80 backdrop-blur-sm">
            {messages.length > 0 && (
              <div className="flex justify-between items-center mb-3 pb-3 border-b border-slate-800/50">
                ...
                <button
                  onClick={clearChat}
                  className="text-xs text-rose-400 hover:text-rose-300 transition-colors flex items-center gap-1.5 px-2 py-1 rounded-lg hover:bg-rose-500/10"
                >
