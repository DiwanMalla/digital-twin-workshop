            ...
            <div className="max-w-5xl mx-auto">
              <div className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="lg:hidden p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-colors"
              ...
              {messages.length === 0 && !isStreaming && (
                <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                  ...
                  <p className="text-slate-400 text-lg mb-8 max-w-2xl">
                    I&apos;m an AI assistant trained on Diwan Malla&apos;s
                    professional profile. Ask me anything about skills,
                    experience, projects, or career goals!
                  </p>
