...
import { ArrowLeft, Briefcase, CheckCircle, XCircle, TrendingUp, AlertCircle, Sparkles } from "lucide-react";
            ...
            {analysis ? (
                ...
                <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
                  <div className="text-center mb-6">
                    ...
                    <div className="h-3 bg-slate-700 rounded-full overflow-hidden max-w-md mx-auto">
                      <div
                        className={`h-full bg-gradient-to-r ${getScoreGradient(analysis.matchScore)} transition-all duration-1000`}
                        style={{ width: `${(analysis.matchScore / 10) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      {analysis.matchedSkills.map((skill, idx) => (
                        ...
                        >
                          ...
                          {skill.proficiency && (
                            <span className={`text-xs px-2 py-1 rounded-full border ${getProficiencyBadge(skill.proficiency)}`}>
                              {skill.proficiency}
                            </span>
                          )}
                        </div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-12 border border-slate-700 text-center">
                ...
                <p className="text-slate-400">
                  Paste a job description and click "Analyze Match" to see how well you fit the role
                </p>
              </div>
            )}
          </div>
