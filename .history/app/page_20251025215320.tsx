      ...
      <div className="relative max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="text-center mb-8 pt-8">
          ...
          <div className="flex items-center justify-center gap-2 mt-3 text-xs text-slate-500">
            <span className="px-2 py-1 bg-slate-800/50 rounded-full border border-slate-700/50">🔄 Live Streaming</span>
          ...
          <div className="h-[500px] overflow-y-auto p-6 space-y-4">
            ...
            {isStreaming && streamingMessage && (
              <div className="flex gap-3 justify-start">
                <div className="max-w-[80%] rounded-2xl px-4 py-3 bg-white/10 backdrop-blur-sm text-white border border-white/10">
                  <p className="text-sm whitespace-pre-wrap">{streamingMessage}</p>
                  <div className="flex items-center gap-2 mt-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                    <p className="text-xs opacity-50">Streaming...</p>
                  </div>
                </div>
              </div>
            )}
